    ...
    <>
      ...
      <main className="min-h-screen text-gray-800 py-16 px-6 space-y-14">
        ...
        <Card className="bg-white/90 backdrop-blur-sm shadow-2xl shadow-black/20 border border-gray-300">
          <CardContent className="space-y-8 pt-8 pb-10 px-6">
            ...
            {scrapingStatus && !error && !playlistLink && (
              <div className="bg-cyan-900/20 border border-cyan-500/30 rounded-lg p-4 text-cyan-300 text-sm">
                <p>{scrapingStatus}</p>
                {progress > 0 && (
              ...
              <div className="space-y-6">
                ...
                {!isSignedIn && (
                  <div className="bg-cyan-900/20 border-2 border-cyan-500/40 rounded-lg p-6 text-center space-y-4">
                    ...
                    <h3 className="text-xl font-bold text-cyan-300">Sign in to save to YouTube</h3>
                ...
                {isSignedIn && (
                  <div className="space-y-4">
                    <div className="space-y-4">
                      <label className="block text-sm font-medium text-cyan-400">Playlist Name</label>
                      <Input
          ...
          <Card className="bg-emerald-900/20 border-2 border-emerald-500/40 backdrop-blur-sm shadow-2xl shadow-black/50">
            <CardContent className="p-6 text-center space-y-6">
              ...
              <div className="pt-4 border-t border-emerald-500/30">
                <p className="text-sm text-gray-300 mb-3">How was your experience?</p>
                <div className="flex justify-center space-x-4">
                  ...
                  >
                    <span className="text-2xl">👎</span>
                    <span className="text-gray-300 font-medium">Needs work</span>
                  </button>
                </div>
              </div>
              ...
              {addedTracks.length > 0 && (
                <details className="text-left text-sm mt-4">
                  ...
                  <ul className="list-disc list-inside space-y-1 mt-2 text-gray-300 max-h-48 overflow-y-auto">
        ...
        <div className="text-center text-base space-y-4">
          <p className="text-cyan-400 font-medium text-lg">☕ Enjoying this tool?</p>
          <a
          ...
          <p className="text-blue-400 font-medium">🌍 Share this app with friends and music lovers</p>
        </div>
